...
// Ask server to add the room if room name is provided by the user
if (room !== '') {
  socket.emit('create or join', room);
  console.log('Attempted to create or join room', room);
}

// Event - Client has created a room i.e. is the first member of the room
...
// Display the Local Stream and Remote Stream on the webpage
...
// Functionality if local stream is found
...
function createPeerConnection() {
  try {
    ...
    pc.onremovestream = handleRemoteStreamRemved;
